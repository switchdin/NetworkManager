                                           ...
                                           GError **error)
{
	...
	if (NM_IN_SET (pmf, NM_SETTING_WIRELESS_PMF_OPTIONAL, NM_SETTING_WIRELESS_PMF_REQUIRED)) {
		if (!nm_supplicant_config_add_option (self,
		                                      "ieee80211w",
		                                      pmf == NM_SETTING_WIRELESS_PMF_OPTIONAL ? "1" : "2",
		                                      -1,
		                                      NULL,
		                                      error))
			return FALSE;
                                                    ...
                                                    GError **error)
{
	...
	} else if (pmf == NM_SETTING_WIRELESS_PMF_REQUIRED) {
		if (nm_streq (key_mgmt_conf, "wpa-psk"))
