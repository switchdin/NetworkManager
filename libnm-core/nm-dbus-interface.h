...
/**
 * NM80211WpsFlags:
 * @NM_802_11_AP_WPS_AUTO: Use of WPS can be attempted. If an AP has this value
 ...
 * @NM_802_11_AP_WPS_DISABLED: WPS can not be used.
 * @NM_802_11_AP_WPS_UNKNOWN: WPS is available but the method was not recognized.
 * @NM_802_11_AP_WPS_PBC: PBC is available and the button was possibly pressed.
 * @NM_802_11_AP_WPS_PIN: PIN method is available
 *
...
typedef enum { /*< underscore_name=nm_802_11_wps_flags, flags >*/
	NM_802_11_AP_WPS_AUTO     = 0x00000000,
	NM_802_11_AP_WPS_DISABLED = 0x00000001,
	NM_802_11_AP_WPS_UNKNOWN  = 0x00000002,
	NM_802_11_AP_WPS_PBC      = 0x00000004,
	NM_802_11_AP_WPS_PIN      = 0x00000008,
} NM80211WpsFlags;
